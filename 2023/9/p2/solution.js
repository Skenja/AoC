...
const fillNextSequenceValue = (previousSequence, sequence) => {
    const lastValue = previousSequence[0];
    const nextValue = sequence[0] - lastValue;
    return sequence.unshift(nextValue);
};
